...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password) || empty($confirm_password) || empty($full_name)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO admin_users (username, password, full_name, profile_image) 
...
<head>
    ...
    <style>
        ...
        .navbar {
            flex-shrink: 0; /* Prevent navbar from collapsing with flexbox */
        }
        .form-container {
...
<body>
    ...
    <!-- Center the form inside a dedicated container -->
    <div class="form-container">
        <div class="signup-card">
            <h3 class="text-center">Seller Sign Up</h3>
            <?php if ($error): ?>
